...
main(int argc, char** argv) {
    Kokkos::initialize(argc, argv);
    {
        ...
        check(packed ==
                  std::vector<VVM::Real>({10102, 10103, 10202, 10203, 20102, 20103, 20202, 20203}),
            "3-D pack order and halo exclusion");

        Kokkos::View<VVM::Real****, Kokkos::LayoutRight, Kokkos::HostSpace> four("four",
            2,
            3,
            3,
            4);
        ...
        FieldSelection s4{4, {2, 1, 1, 2}, {0, 0, 0, 0}, {2, 1, 1, 2}, {0, 1, 1, 1}, {2, 3, 3, 4}};
        ...
        check(packed_f32 ==
                  std::vector<float>({10102, 10103, 10202, 10203, 20102, 20103, 20202, 20203}),
        ...
        check(packed_f64 ==
                  std::vector<double>({10102, 10103, 10202, 10203, 20102, 20103, 20202, 20203}),
        ...
        Kokkos::View<VVM::Real*, Kokkos::LayoutRight, Kokkos::HostSpace> lossy("lossy", 4);
    ...
    Kokkos::finalize();
    if (failures == 0) {
        std::puts("test_cpu_field_source: PASS");
    }
