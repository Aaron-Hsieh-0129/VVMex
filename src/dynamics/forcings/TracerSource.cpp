...
TracerSource::TracerSource(const Core::Grid& grid, const Core::State& state)
    : grid_(grid), target_vars_(state.get_tracer_source_targets()) {}

void
TracerSource::apply(Core::State& state, VVM::Real dt) const {
