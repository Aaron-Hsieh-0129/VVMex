...
void TwistingTerm::compute_tendency(
    ...
    if (variable_name_ == "xi") {
        scheme_->calculate_twisting_tendency_x(state, grid, params, out_tendency);
    } 
    else if (variable_name_ == "eta") {
        scheme_->calculate_twisting_tendency_y(state, grid, params, out_tendency);
    } 
    else if (variable_name_ == "zeta") {
        scheme_->calculate_twisting_tendency_z(state, grid, params, out_tendency);
    }
}
