...
inline HorizontalWindReconstructionDeviceView
make_horizontal_wind_reconstruction_device_view(
    ...
    if (geometry.kind() != GeometryKind::Cartesian &&
        ...
        throw std::invalid_argument("HorizontalWindReconstruction currently supports Cartesian and "
