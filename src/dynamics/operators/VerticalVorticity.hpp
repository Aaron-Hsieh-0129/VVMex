...
struct VerticalVorticityDeviceView {
    ...
    calculate_at_z(const ContravariantQ1View& contravariant_q1_at_u,
        ...
        covariant_vector.q1_at_u_j_i =
            vector_lowering.calculate_covariant_q1_at_u(contravariant_q1_at_u,
                contravariant_q2_at_v,
                j,
                i);
        covariant_vector.q1_at_u_jp1_i =
            vector_lowering.calculate_covariant_q1_at_u(contravariant_q1_at_u,
                contravariant_q2_at_v,
                j + 1,
                i);
        covariant_vector.q2_at_v_j_i =
            vector_lowering.calculate_covariant_q2_at_v(contravariant_q1_at_u,
                contravariant_q2_at_v,
                j,
                i);
        covariant_vector.q2_at_v_j_ip1 =
            vector_lowering.calculate_covariant_q2_at_v(contravariant_q1_at_u,
                contravariant_q2_at_v,
                j,
                i + 1);
...
inline VerticalVorticityDeviceView
make_vertical_vorticity_device_view(const Core::Geometry::HorizontalGeometry& geometry) {
